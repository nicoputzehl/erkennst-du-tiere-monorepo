import { QuestionBase, HintUtils } from "@quiz-app/shared";
...
export const namibia: QuestionBase[] = [
	...
	},
	{
		...
		hints: [
			...
			HintUtils.createAutoFreeHint(2, "Ich bin ein großes Säugetier, das viel Zeit im Wasser verbringt und dessen Name 'Pferd des Flusses' Flussbedeutet.", 7)
		],
	},

	{
		...
		hints: [
			...
			HintUtils.createAutoFreeHint(2, "Ich bin ein Stelzvogel, bekannt für meine leuchtende Farbe und dass ich oft auf einem Bein stehe.", 4)
		],
	},
	{
		id: 4,
		...
		hints: [
			HintUtils.createLetterCountHint(4),
			HintUtils.createFirstLetterHint(4),
			HintUtils.createAutoFreeHint(4, "Man nennt mich auch den König der Tiere.")
		],
	},
	...
	// },
	{
		...
		hints: [
			...
			HintUtils.createAutoFreeHint(6, "Den Namensgebenden Teil meines Gesichts kann man nicht sehen.")
		],
	},
	{
		id: 7,
		...
		hints: [
			...
			HintUtils.createAutoFreeHint(6, "Ich bin mit Pferden verwandt.")
		],
	},
	{
		id: 8,
		...
		hints: [
			...
			HintUtils.createAutoFreeHint(8, "Steck mal nicht den Kopf in den Sand.")
		],
	},
	// {
	// 	id: 9,
	...
	// },
	{
		...
		hints: [
			HintUtils.createLetterCountHint(10),
			HintUtils.createFirstLetterHint(10),
			HintUtils.createAutoFreeHint(10, "Tööröö", 3)
		],
	},
	// {
	// 	id: 11,
	...
	// },
	{
		...
		hints: [
			HintUtils.createLetterCountHint(12),
			HintUtils.createFirstLetterHint(12),
			HintUtils.createContextualHint(12, ["Erdmännchend"], "Die gesuchten Tieren bilden sogar manchmal WGs mit Erdmännchen.", { title: "Könnte man meinen" }),
			HintUtils.createContextualHint(12, ["Eichhörnchen", "Streifenhörnchen", "Hörnchen"], "Hönrchen ist schonmal nicht schlecht.", { title: "Fast...." })
		],
	},
	{
		id: 13,
		...
		hints: [
			HintUtils.createLetterCountHint(13),
			HintUtils.createFirstLetterHint(13),
			HintUtils.createAutoFreeHint(13, "Schwer zu erkennen. Aber versuch mal das Muster zu erkennen.", 3),
			HintUtils.createAutoFreeHint(13, "Die Zunge des gesuchten Tieres kann 45-50 Zentimeter lang werden und ist oft bläulich-violett gefärbt", 6)
		],
	},
	{
		id: 14,
		...
		hints: [
			HintUtils.createLetterCountHint(14),
			HintUtils.createFirstLetterHint(14),
			HintUtils.createAutoFreeHint(14, "Nicht Timon!", 3)
		],
	},
	{
		id: 15,
		...
		hints: [
			HintUtils.createLetterCountHint(15),
			HintUtils.createFirstLetterHint(15),
			HintUtils.createAutoFreeHint(15, "Denk mal an die Farbe des Schnabels.", 4),
			HintUtils.createAutoFreeHint(15, "Sein Name verrät schon einiges über sein markantestes Merkmal.", 8)
		],
	},
];
